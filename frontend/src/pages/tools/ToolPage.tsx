...
import { ArrowLeft, Paperclip, X, FileText, Image } from 'lucide-react';
...
export default function ToolPage() {
  ...
  const canSubmit = input.trim().length > 0 || attachedFile !== null;
    ...
    <div>
      ...
      {fullResult ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Quick Templates */}
          <div>
            <p className="text-xs font-medium text-gray-500 mb-2 uppercase tracking-wide">Quick templates</p>
          ...
          {/* File Upload */}
          <div>
            <p className="text-xs font-medium text-gray-500 mb-2 uppercase tracking-wide">Attach document or photo</p>
            <input
              ref={fileInputRef}
              type="file"
            ...
            {attachedFile ? (
              <div className="flex items-center gap-3 bg-white border border-gray-200 rounded-xl px-4 py-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400">{attachedFile.type.startsWith('image/') ? 'Image' : 'PDF'} · ready to analyze</p>
                </div>
                <button
                  type="button"
          ...
          {loading ? (
            <Loader text="AI is analyzing your case..." />
          ) : (
            <button
              type="submit"
              disabled={!canSubmit}
